...
#include "pvs_countpairs_bruteforce.h" //function proto-type for countpairs
...
int main(int argc, char *argv[])
{
    ...
    /*---Count-pairs--------------------------------------*/
    gettimeofday(&t0,NULL);
    results_pvs_countpairs *results = countpairs_pvs_bruteforce(ND1,x1,y1,z1, vx1, vy1, vz1,
